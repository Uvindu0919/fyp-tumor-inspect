...
def dst_for_single(ann_preds, svm_preds, knn_preds):
        belief_function_knn = probabilities_to_belief_function(knn_preds)
        belief_function_svm = probabilities_to_belief_function(svm_preds)
        belief_function_ann = probabilities_to_belief_function(ann_preds)
